...
import com.datienza.spacex.feature.rocketinfo.view.RocketInfoFragmentArgs
import com.datienza.spacex.feature.rockets.view.RocketsFragmentDirections
...
class MainActivityRouterImpl @Inject constructor(
    ...
    override fun goToRocketInfo(rocketId: String, rocketDescription: String) {
        val action = RocketsFragmentDirections
            .actionRocketsFragmentToRocketinfoGraph(rocketId, rocketDescription)
